...
void DrawEnerCollRatio2(
  ...
  t->Draw("iY:iX>>hN","(iHit==0)","colz"); cout<<46<<endl;
   cout<<47<<endl;
  c3->cd(1);
  ...
  t->Draw("iY:iX>>h1","Edep/Edep3*(iHit==0)","colz"); cout<<52<<endl;
  c3->cd(2);
  ...
  t->Draw("iY:iX>>h3","Edep/Edep5*(iHit==0)","colz"); cout<<57<<endl;
  c3->cd(3);
  ...
  t->Draw("iY:iX>>h5","Edep/EdepA*(iHit==0)","colz"); cout<<62<<endl;
  ...
  h1N->SetStats(0);
  h1N->Sumw2();
  t->Draw("GID>>h1N","(iHit==0)","h");  cout<<94<<endl;
  ...
  h11->Sumw2();
  t->Draw("GID>>h11","Edep/Edep3*(iHit==0)","he"); cout<<106<<endl;
  h11->Divide(h1N);
  float mintmp = 1;
  for(int i=0;i<64;i++){
  ...
  t->Draw("GID>>h13","Edep/Edep5*(iHit==0)","hesame");  cout<<118<<endl;
  h13->Divide(h1N);
  h13->SetLineColorAlpha(2,.5);
  h13->Sumw2();
  TH1F *h15 = new TH1F("h15","h15",64,0,64); 
  t->Draw("GID>>h15","Edep/EdepA*(iHit==0)","hesame"); cout<<123<<endl;
  h15->Divide(h1N);
  ...
  c4->Print(Form("%s/collectionEffOfPeakChannel2.png",FileRoot.data()));
  c4->Print(Form("%s/collectionEffOfPeakChannel2.pdf",FileRoot.data()));
  c4->Print(Form("%s/collectionEffOfPeakChannel2.gif",FileRoot.data()));
